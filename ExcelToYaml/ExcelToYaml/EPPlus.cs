    ...
    namespace EPPlus
    {
        ...
        class SeedTable : SeedTableBase
        {
            ...
            void CheckColumns()
            {
                if (IdColumnIndex == 0)
                {
                    Errors.Add(new NoIdColumnException($"key column [{KeyColumnName}] not found [{SheetName}]"));
                }
                ...
                foreach (var column in Columns)
                {
                    ...
                    {
                        Errors.Add(new DuplicateColumnNameException($"Duplicate column name [{columnName}] found in sheet [{SheetName}]"));
                    }
